...
- 2,000 GitHub stars, accumulated over roughly eleven months.
- Over 10,000 downloads a month.
- A growing core team.
- A steady stream of contributors opening issues, reviewing PRs, and sticking around even when things are difficult.
...
- [Nanocoder on GitHub](https://github.com/Nano-Collective/nanocoder) (issues, PRs, and discussions)
- The [Nano Collective Discord](https://discord.gg/ktPDV6rekE) (real-time chat with the community and core team)
- [nanocollective.org](https://nanocollective.org) (the collective's home)

If you want to get involved, every project has a `CONTRIBUTING.md` with setup instructions. Look for issues tagged `good first issue` if you're not sure where to start.
